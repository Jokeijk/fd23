...
//  snap.write((char*)&nz,4);
  snap.write((char*)fld.BU,sizeof(double)*nx*nz);
  snap.close();
...
void snapshot(FIELD & fld,int it){
  ...
  sprintf(snapfile,"U%05d_db",it);
  snap.open(snapfile,ios::binary);
//  snap.write((char*)&nx,4);
//  snap.write((char*)&nz,4);
  snap.write((char*)fld.U,sizeof(double)*nx*nz);
  snap.close();

  sprintf(snapfile,"W%05d_db",it);
  snap.open(snapfile,ios::binary);
//  snap.write((char*)&nx,4);
//  snap.write((char*)&nz,4);
  snap.write((char*)fld.W,sizeof(double)*nx*nz);
  snap.close();
/*
