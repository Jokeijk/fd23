...
" npml=32         #     pml need to be toned if you want very good result",
" pml_dt=         #     pml dt, similar to dt",
" pml_v=          #     pml v, similar to vp",
" pml_r=          #     pml r, target reflection coefficient",
" pml_fc=         #     pml frequency",
...
" usetable=0       #      will make table, maybe slow",
